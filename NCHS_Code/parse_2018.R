# 2018 CDC data .txt file tried to parse using this code, but it only returned a million 
# records instead of the expected 2 million. keeping this code just in case, but something's
# wrong. 
  ```{r}
...
write.csv(mort2018, "Data/mort2018.csv")
```