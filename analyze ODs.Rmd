...
S1_p <- ODs_stim_and_opioids_summary %>% 
  ...
  ggplot(aes(x = year, y = num_deaths, color = fct_relevel(drug, "H no Stim", "F no Stim", "H+F no Stim"))) + 
...
S2_p <- ODs_stim_and_opioids_summary %>% 
  ...
  ggplot(aes(x = year, y = num_deaths, color = fct_relevel(drug, "H+PS", "F+PS", "H+F+PS"))) + 
...
S3_p <- ODs_stim_and_opioids_summary %>% 
  ...
  ggplot(aes(x = year, y = num_deaths, color = fct_relevel(drug,"H+Cocaine", "F+Cocaine", "H+F+Cocaine"))) + 
...
S4_p <- ODs_stim_and_opioids_summary %>% 
  ...
  ggplot(aes(x = year, y = num_deaths, color = fct_relevel(drug, "H+PS+Cocaine", "F+PS+Cocaine", "H+F+PS+Cocaine"))) + 
